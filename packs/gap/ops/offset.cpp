...
void registerPointOffset(Registry& r) {
  ...
  op.preconditions = {
      "dx / dy 是**测量帧坐标轴**上的分量，不沿任何拟合出来的面分解；零件整体转过一个角"
      "度，两个分量会一起变。",
      "a、b 由上游选点算子给定，本算子不检查它们是不是同一条缝的两侧。",
      "absDx / absDy 打开后把正负两侧折成同一个方向，扰动灵敏度检查会跟着失效。",
  };
  op.inputs = {
  ...
  op.params = {
      boolParam("absDx", "Abs Dx", false, "输出 |dx|。"),
      boolParam("absDy", "Abs Dy", false, "输出 |dy|。"),
